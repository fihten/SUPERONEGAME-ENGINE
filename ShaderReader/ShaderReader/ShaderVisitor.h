...
public:
	...
	virtual void startVisit(const ShaderUnits::INT2* pINT2) {};
	virtual void startVisit(const ShaderUnits::UINT1* pUINT) {};
	...
	virtual void startVisit(const ShaderUnits::LINE_STREAM* pLINE_STREAM) {};
	...
	virtual void startVisit(const ShaderUnits::SET_GEOMETRY_SHADER* pSET_GEOMETRY_SHADER) {};
	...
	virtual void startVisit(const ShaderUnits::POINT* pPOINT) {};
	...
	virtual void startVisit(const ShaderUnits::INCREMENT* pINCREMENT) {};
	...
	virtual void finishVisit(const ShaderUnits::INT2* pINT2) {};
	virtual void finishVisit(const ShaderUnits::UINT1* pUINT) {};
	...
	virtual void finishVisit(const ShaderUnits::LINE_STREAM* pLINE_STREAM) {};
	...
	virtual void finishVisit(const ShaderUnits::SET_GEOMETRY_SHADER* pSET_GEOMETRY_SHADER) {};
	...
	virtual void finishVisit(const ShaderUnits::POINT* pPOINT) {};
	...
	virtual void finishVisit(const ShaderUnits::INCREMENT* pINCREMENT) {};
